...
public class Blackboard : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        sc_worldState.AddState(new State("CanSee"));
        sc_worldState.AddState(new State("HasPath"));
        sc_worldState.AddState(new State("IsAlive", true));
        sc_worldState.AddState(new State("IsTired"));
        sc_worldState.AddState(new State("NearTarget"));
    ...
    private void UpdateDebugText()
    {
        ...
        {
            tL_actionText[j].text = $"{aL_actionSet[j].ActionName}: {aL_actionSet[j].CheckActionEligibility(sc_worldState)}";
        }
